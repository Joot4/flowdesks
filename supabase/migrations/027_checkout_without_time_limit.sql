-- Regra: check-out sem horario limite maximo.
-- Mantem validacoes de permissao, geofence e obrigatoriedade de check-in.
...
begin
  ...
  if p_action = 'IN' then
    ...
    -- Sem limite maximo de horario para check-out.
